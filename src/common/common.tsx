...
export const BASE_ACTIVITIES_CARDS_CONTENT: Array<BaseActivity> = [
  ...
  {
    title: `Карьерные консультации с${TYPO.NBSP}экспертами`,
    description: `Садимся за${TYPO.NBSP}стол с${TYPO.NBSP}лидами и${TYPO.NBSP}сеньорами мобильной разработки из${TYPO.NBSP}Яндекса и${TYPO.NBSP}не${TYPO.NBSP}только. Задавайте вопросы и${TYPO.NBSP}получите советы про${TYPO.NBSP}рост, выбор технологий и${TYPO.NBSP}поиск смыслов.`,
  },
  {
    title: `Квиз про${TYPO.NBSP}мобильную разработку`,
    description: `Собираем команду из${TYPO.NBSP}разработчиков прямо на${TYPO.NBSP}фестивале и${TYPO.NBSP}пробуем свои силы в${TYPO.NBSP}знаниях технологий и${TYPO.NBSP}отсылок в${TYPO.NBSP}кино.`,
  },
  {
    title: `Игра ${TYPO.LAQUO}Кот Кодерун${TYPO.RAQUO}`,
    description: `Решаем задачи на${TYPO.NBSP}время на${TYPO.NBSP}нашей тренировочной платформе CodeRun под${TYPO.NBSP}бодрое музыкальное сопровождение.`,
  },
  {
    title: `AI-хакатон`,
    description: `Соревнование для${TYPO.NBSP}опытных разработчиков${TYPO.NBSP}&mdash; попробуете создать работающий продукт за${TYPO.NBSP}время фестиваля и${TYPO.NBSP}получите ценные призы от${TYPO.NBSP}Яндекса.`,
  },
]
